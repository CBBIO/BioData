...
from .embeddings_pooler import mean_pool_embedding_record
from .embeddings_writer import _H5EmbeddingWriter  # pyright: ignore[reportPrivateUsage]
...
def generate_fasta_pickle_shards(
    ...
    *,
    ...
    from .embeddings_batcher import FastaBatcher
    from .embeddings_jobs import run_embedding_generation
    from .embeddings_pooler import pooler_factory
