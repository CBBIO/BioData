    ...
    def __init__(
        ...
        *,
        ...
        if resolved_model is None or resolved_alphabet is None:
            ...
            loader = getattr(esm.pretrained, "esm1b_t33_650M_UR50S", None)
            if loader is None or not callable(loader):
                raise EmbeddingDependencyError("ESM pretrained loader not available: esm1b_t33_650M_UR50S")
        ...
        if padding_idx is None:
            raise EmbeddingBackendError("ESM1b alphabet missing padding_idx.")

        super().__init__(
            model_reference=model_name,
            preprocessor=Esm1bPreprocessor(),
            tokenizer=Esm1bTokenizerAdapter(resolved_converter, padding_idx=int(padding_idx)),
